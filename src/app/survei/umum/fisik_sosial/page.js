...
export default function SurveiFisikSosial () {
    ...
    return (
        <div className="relative my-[200px] flex items-center justify-center">
            ...
            <div className="xl:w-[980px] lg:w-[980px] md:w-[780px] xl:h-[1430px] lg:h-[1430px] md:h-[1430px] h-[1540px] w-[400px] py-[30px] px-[20px] bg-white shadow-xl border-2 border-bg-btn-orangeHover flex items-center">
                <div className="xl:w-[980px] lg:w-[980px] md:w-[780px] w-[355px]">
                    <h1 className="text-center text-[28px] font-bold">SURVEI UMUM</h1>
                    <h1 className="text-[18px] font-medium mt-3">I. LINGKUNGAN (FISIK DAN SOSIAL)</h1>
                    ...
                    <div className="perumahan mb-3">
                        <h3 className="font-bold">A. Perumahan</h3>
                    ...
                    <div className="sumberAir mb-3">
                        <h3 className="font-bold">B. Sumber Air</h3>
                        <div className="pertanyaan ms-5">
                            <div>
                    ...
                    <div className="pembuanganSampah mb-3">
                        <h3 className="font-bold">C. Pembuangan Sampah</h3>
                        <div className="pertanyaan ms-5">
                            <div>
                    ...
                    <div className="lingkunganSosial">
                        <h3 className="font-bold">D. Lingkungan Sosial</h3>
                        <div className="pertanyaan ms-5">
                            <div>
                    ...
                    <div className="my-[20px] flex justify-center button-group">
                        <button onClick={(e)=>{e.preventDefault(); lingkungan()}} className="bg-bg-btn-orangeLight hover:bg-bg-btn-orangeHover text-[16px] font-semibold  py-4 xl:px-[400px] lg:px-[400px] px-[120px]">Selanjutnya</button>
                    </div>
                </div>
            </div>
        </div>
